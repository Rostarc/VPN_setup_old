...
Этот скрипт не может работать на версиях убунту выше 16.04, так как в следующих версиях работа некоторых пакетов изменилась. Поэтому нужно использовать болеее новый скрипт для автоматической настройки для новых версий убунту, например для убунту 22.04 (https://github.com/vpn-vendor/vpn)
